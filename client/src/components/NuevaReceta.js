...
const NuevaReceta = () => {
    ...
    const [gluten, setGluten] = useState(true);//el true es que va a tener check por default
    ...
    return (
        <div>
            ...
            <form onSubmit={guardarReceta}>
                ...
                <div>
                    <input type="checkbox" name="diabeticos" checked={diabeticos} onChange={diabeticos ? e => setDiabeticos(false) : e=> setDiabeticos(true)}></input>
